...
//***********************************************************************************************
typedef const PaletteClass* WOLPALETTE;
...
public:
    ...
    bool
        bEgg8Player; //	True = 8 player games can be created. This is hidden so that we don't really have to support the feature...
...
protected:
    void GetGameTypeInfo(int iGameType, WOL_GAMETYPEINFO& GameTypeInfo, WOLPALETTE hPal);
